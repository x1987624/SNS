...
//--------------------------------------------------------------
//<version>V0.5</verion>
//<createdate>2011-1-04</createdate>
//<author>libsh</author>
//<email>libsh@tunynet.com</email>
//<log date="2012-1-04" version="0.5">创建</log>
//--------------------------------------------------------------
//</TunynetCopyright>
...
namespace Tunynet.Utilities
{
    ...
    public class TrustedHtml
    {
        ...
        {
            if (_globalAttributes.Contains(attr) || (_attributes.ContainsKey(tag) && _attributes[tag].Contains(attr)))
            {
