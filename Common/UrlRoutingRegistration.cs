...
namespace Spacebuilder.Common
{
    ...
    public class UrlRoutingRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                "UserSpace_Settings_SetPresentAreaNavigationStatus", // Route name
                "u/{spaceKey}/Settings/SetPresentAreaNavigationStatus" + extensionForOldIIS, // URL with parameters
                new { controller = "UserSpaceSettings", action = "SetPresentAreaNavigationStatus" } // Parameter defaults
            );

            context.MapRoute(
                "UserSpace_Settings_SetPresentAreaNavigationTargetStatus", // Route name
                "u/{spaceKey}/Settings/SetPresentAreaNavigationTargetStatus" + extensionForOldIIS, // URL with parameters
                new { controller = "UserSpaceSettings", action = "SetPresentAreaNavigationTargetStatus" } // Parameter defaults
            );
            ...
            context.Routes.MapHttpHandler<UEditorHandler>("UEditor", "Handlers/UEditor.ashx");
