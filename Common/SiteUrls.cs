...
namespace Spacebuilder.Common
{
    ...
    public class SiteUrls
    {
        ...
        /// 动态列表
        /// </summary>
        public string _MyTimeline(string spaceKey, long? groupId = null, long? applicationId = null, bool? isOriginalThread = null, MediaType? mediaType = null, int? pageIndex = null)
        {
            RouteValueDictionary routeValueDictionary = new RouteValueDictionary();
            ...
            if (isOriginalThread != null)
                routeValueDictionary.Add("isOriginalThread", isOriginalThread);
            if (mediaType != null)
                routeValueDictionary.Add("mediaType", mediaType);
            if (pageIndex != null)
                routeValueDictionary.Add("pageIndex", pageIndex);
            return CachedUrlHelper.Action("_MyTimeline", "UserSpace", CommonAreaName, routeValueDictionary);
        }

        /// <summary>
        /// 动态列表
        /// </summary>
        public string _UserActivities(string spaceKey, int? applicationId = null, int? pageIndex = null)
        {
            RouteValueDictionary routeValueDictionary = new RouteValueDictionary();
            ...
            if (pageIndex != null)
                routeValueDictionary.Add("pageIndex", pageIndex);
            return CachedUrlHelper.Action("_UserActivities", "UserSpace", CommonAreaName, routeValueDictionary);
        }
        ...
        {
            ISettingsManager<LinktimelinessSettings> linktimelinessSettingsManager = DIContainer.Resolve<ISettingsManager<LinktimelinessSettings>>();
        ...
        {
            return CachedUrlHelper.Action("_EditAvatarAsyn", "UserSpaceSettings", CommonAreaName, new RouteValueDictionary { { "spaceKey", spaceKey }, { "t", new Random().Next(1, 100).ToString() } });
        }
        ...
        /// 编辑标签页 及 提交表单
        /// </summary>
        public string _EditMyTag(string spaceKey, long tagId, string tenantTypeId)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("tagId", tagId);
            dic.Add("tenantTypeId", tenantTypeId);
        ...
        /// 编辑分类页 及 提交表单
        /// </summary>
        public string _EditMyCategory(string spaceKey, long categoryId)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
        ...
        /// 设置呈现区域导航新窗打开状态
        /// </summary>
        public string SetPresentAreaNavigationTargetStatus(string spaceKey)
        {
            return CachedUrlHelper.Action("SetPresentAreaNavigationTargetStatus", "UserSpaceSettings", CommonAreaName, new RouteValueDictionary { { "spaceKey", spaceKey } });
        }

        /// <summary>
        /// 设置呈现区域导航状态
        /// </summary>
        public string SetPresentAreaNavigationStatus(string spaceKey)
        {
            return CachedUrlHelper.Action("SetPresentAreaNavigationStatus", "UserSpaceSettings", CommonAreaName, new RouteValueDictionary { {"spaceKey",spaceKey}});
        }
        ...
        /// <returns></returns>
        public string _SiteActivities(int pageIndex = 1)
        {
            return CachedUrlHelper.Action("_SiteActivities", "Channel", CommonAreaName, new RouteValueDictionary { { "pageIndex", pageIndex } });
        }
        ...
        /// 添加、编辑标签
        /// </summary>
        public string _EditTag(long tagId = 0)
        {
            if (tagId > 0)
            {
                return CachedUrlHelper.Action("_EditTag", "ControlPanelContent", CommonAreaName, new RouteValueDictionary { { "tagId", tagId } });
            }
            else
            {
                return CachedUrlHelper.Action("_EditTag", "ControlPanelContent", CommonAreaName);
            }
        }
        ...
        /// </summary>
        /// <param name="spaceKey">用户名</param>
        public string _NewMicroblogActivity()
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            return CachedUrlHelper.Action("_NewActivity", "MicroblogActivity", "Microblog");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public string UserLastestRecord()
        {
            return CachedUrlHelper.Action("UserLastestRecord", "Channel", CommonAreaName);
        }
        ...
        /// <param name="pageIndex"></param>
        /// <returns></returns>
        public string _SpaceHomeMore(string spaceKey, int type = 0, int pageIndex = 1)
        {
            return CachedUrlHelper.Action("_SpaceHomeMore", "Follow", CommonAreaName, new RouteValueDictionary { { "spaceKey", spaceKey }, { "type", type }, { "pageIndex", pageIndex } });
        }
