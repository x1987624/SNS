...
function showWindow(k, url, mode, cache, menuv) {
    ...
    var fetchContent = function () {
        if (mode == 'get') {
            ...
            ajaxget(url, 'fwin_content_' + k, null, '', '',
            function () {
                initMenu();
                show();
            });
...
function initSearchmenu(searchform, cloudSearchUrl) {
    var defaultUrl = 'http://discuz.uuhey.com/yl5361_city_d4/static/js/search.php?searchsubmit=yes';
...
function patchNotice() {
    if ($('patch_notice')) {
        ajaxget('http://discuz.uuhey.com/yl5361_city_d4/static/js/misc.php?mod=patch&action=patchnotice', 'patch_notice', '');
    }
}
function pluginNotice() {
    if ($('plugin_notice')) {
        ajaxget('http://discuz.uuhey.com/yl5361_city_d4/static/js/misc.php?mod=patch&action=pluginnotice', 'plugin_notice', '');
    }
}
function ipNotice() {
    if ($('ip_notice')) {
