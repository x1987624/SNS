(function(z, v) {
	...
	(function() {
		...
		d.innerHTML = "   <link/><table></table><a href='http://discuz.uuhey.com/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>";
	...
	c.fn.extend({
		...
		toggleClass: function(a, b) {
			...
			return this.each(function() {
				if (d === "string") for (var e, i = 0, j = c(this), n = b, o = a.split(ca); e = o[i++];) {
					n = f ? n : !j.hasClass(e);
