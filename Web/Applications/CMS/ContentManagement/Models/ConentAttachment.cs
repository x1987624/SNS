...
namespace Spacebuilder.CMS
{
    ...
    /// 附件实体
    /// </summary>
    [TableName("spb_cms_ContentAttachments")]
    [PrimaryKey("AttachmentId", autoIncrement = true)]
    [CacheSetting(true, PropertyNamesOfArea = "UserId")]
    [Serializable]
    public class ContentAttachment : SerializablePropertiesBase, IEntity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public ContentAttachment(System.Web.HttpPostedFileBase postedFile, string contentType = null)
        {
            New();//初始化属性默认值
        ...
        /// <param name="postedFile"></param>
        /// <param name="contentType">指定contentType，会优先采用此contentType</param>
        public ContentAttachment(System.Web.HttpPostedFile postedFile, string contentType = null)
        {
            New();//初始化属性默认值
            this.FileLength = postedFile.ContentLength;
        ...
        public ContentAttachment(Stream stream, string contentType, string friendlyFileName)
        {
            New();//初始化属性默认值
            this.ContentType = contentType;
            this.MediaType = GetMediaType(this.ContentType);
        ...
        public virtual string GetRelativePath()
        {
            ...
            string[] datePaths = new string[] { "ContentItem" };
        ...
        protected MediaType GetMediaType(string contentType)
        {
            ...
            else if (this.ContentType.StartsWith("application/vnd.") || this.ContentType.IndexOf("application/msword") != -1)
